...
if (console.run_gc == undefined) console.run_gc = function() { console.log("Run GC"); };
if (console.memory_usage == undefined) console.memory_usage = function(simple) { console.log("Memory Usage"); };
if (ConfigManager.isDefaultLanguage == undefined) ConfigManager.isDefaultLanguage = function() { return true; };
if (ConfigManager.getLanguage == undefined) ConfigManager.getLanguage = function() { return "EN"; };
	...
	{
		if (this.firstBoot == true)
		{
			this.firstBoot = false;
			if (RG19.GetEnvironment("SYSLANGCC") == "JP")
			{
				this.language = 1;
			}
			else
		...
		return _ConfigManager_getLanguage.call(this);
	};
